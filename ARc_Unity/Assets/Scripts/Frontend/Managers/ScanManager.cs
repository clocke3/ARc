...
namespace BarcodeScanner.Scanner
{
    ...
    public class ScanManager : ItemManager, IScanner
    {
        ...
        public ScanManager() : this(null, null, null) { }
        public ScanManager(ScannerSettings settings) : this(settings, null, null) { }
        public ScanManager(IParser parser, IWebcam webcam) : this(null, parser, webcam) { }

        public ScanManager(ScannerSettings settings, IParser parser, IWebcam webcam)
        {
